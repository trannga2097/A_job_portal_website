	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        ...
	        <ul class="navbar-nav ml-auto">
              ...
              if (isset($_SESSION['email'])==true){ ?>
                ...
                <li class="nav-item cta cta-colored"><a href="logout.php" class="nav-link">
                Logout</a></li>
      ...
      <div class="container">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          ...
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
              ...
              <span class="mr-3"><a href="blog.php">Blog <i class="ion-ios-arrow-forward"></i></a></span> 
php
              <span>Single</span>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8 ftco-animate">
            ...
            <h2 class="mb-3"><?php echo $job_tittle; ?></h2>

            <h5><?php echo $country; ?>,<?php echo $province; ?>,<?php echo $detail_address; ?></h5>

            <p><?php echo $description; ?></p>

            <form action="apply_job.php" method="POST" id="job_portal" enctype="multipart/form-data" style="border: 1px solid gray; padding: 2%;">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center">
            ...
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">
            </p>
